console.log("File: tests/test_faq_alpha.js");

// Test for faq_alpha function
const path = require('path');

async function runTests() {
    try {
        // Test the function directly
        delete require.cache[require.resolve('../functions/generate_faq_alpha.js')];
        const { generateFAQHTML } = require('../functions/generate_faq_alpha.js');
