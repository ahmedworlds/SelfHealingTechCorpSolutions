console.log("File: tests/test_faq_gamma.js");

// Test for faq_gamma function
const path = require('path');

async function runTests() {
    try {
        // Test the function directly
        delete require.cache[require.resolve('../functions/generate_faq_gamma.js')];
        const { generateFAQHTML } = require('../functions/generate_faq_gamma.js');
