console.log("File: tests/test_portfolio_b.js");

// Test for portfolio_b function
const path = require('path');

async function runTests() {
    try {
        // Test the function directly
        delete require.cache[require.resolve('../functions/generate_portfolio_b.js')];
        const { generatePortfolioHTML } = require('../functions/generate_portfolio_b.js');
