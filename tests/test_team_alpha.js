console.log("File: tests/test_team_alpha.js");

// Test for team_alpha function
const path = require('path');

async function runTests() {
    try {
        // Test the function directly
        delete require.cache[require.resolve('../functions/generate_team_alpha.js')];
        const { generateTeamHTML } = require('../functions/generate_team_alpha.js');
