console.log("File: tests/test_portfolio_a.js");

// Test for portfolio_a function
const path = require('path');

async function runTests() {
    try {
        // Test the function directly
        delete require.cache[require.resolve('../functions/generate_portfolio_a.js')];
        const { generatePortfolioHTML } = require('../functions/generate_portfolio_a.js');
